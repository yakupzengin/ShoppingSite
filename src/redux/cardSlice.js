...
const cartSlice = createSlice({
    ...
    reducers: {
        addToCart: (state, action) => {
            ...
            // eğer ürün daha önceden karta eklenmişse tekrar eklemezsin sayısını arttırsın
            if (isItemCart) {
        ...
        clearCart : (state) => {
             state.carts = [] // temizliyor tamamen
             storeInLocalStorage(state.carts)
        } ,
        getCartTotal : (state) => {
...
// bunları export ettikten sonra istediğimiz yerde istediğimiz gibi kullanabbiliriz
